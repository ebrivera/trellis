                ...
                <div className="border shadow-2xl rounded-3xl bg-white/10 backdrop-blur-xl border-white/20 shadow-black/10">
                    <div className="flex items-center justify-between h-16 gap-4 px-6">
                        ...
                        <Link href="/" className="flex items-center gap-2 shrink-0">
                            <span className="text-lg font-semibold text-white">foundry.</span>
                        </Link>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Link
                                href="/settings"
                                className="hidden md:flex items-center justify-center w-10 h-10 text-white transition-transform rounded-lg hover:bg-white/10 hover:scale-105"
                                aria-label="Settings"
                            >
